...
1. Search for Css Live Reload and install it.
1. Activate the plugin.
1. Continue developing and when are you want to reload your css just click on F9 :)

= Custom Upload: =
1. Download the plugin zip file.
1. Upload the content of zip to your \"wp-content/plugins/\" directory.
1. Login to admin dashboard.
1. Go to Plugins.
1. Search for Css Live Reload and activate it.
1. Continue developing and when are you want to reload your css just click on F9 :)
...
== Screenshots ==
1. Desktop reload by press on F9 key screenshot-1.png
1. Mobile reload by shake the phone screenshot-2.png
